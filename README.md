# PostgreSQL Static Template

This is a static template for PostgreSQL service.
...
| <a name="input_hosts"></a> [hosts](#input\_hosts) | The host list of the PostgreSQL service. | `list(string)` | n/a | yes |
| <a name="input_hosts_readonly"></a> [hosts\_readonly](#input\_hosts\_readonly) | The readonly host list of the PostgreSQL service. | `list(string)` | `[]` | no |
| <a name="input_port"></a> [port](#input\_port) | The port of the PostgreSQL service. | `number` | `5432` | no |
| <a name="input_database"></a> [database](#input\_database) | The name of the PostgreSQL database to access. | `string` | n/a | yes |
